...
export function createGalleryLabel({ lines, collection, number }) {
  ...
  ctx.font='normal 330px Georgia, serif';ctx.fillText(String(number).padStart(2,'0'),48,460,328);
  ...
  ctx.font='normal 86px Georgia, serif';ctx.fillStyle='#242922';
  ...
  ctx.font='37px Georgia, serif';ctx.fillText("angela's cellar",70,859);
